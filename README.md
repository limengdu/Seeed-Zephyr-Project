...
<details>
<summary><b>Linux & Windows</b> (entry points written, real-platform validation in progress)</summary>
...
Windows prepares WSL2 first, then run the Linux setup inside WSL2:
