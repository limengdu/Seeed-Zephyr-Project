...
| XIAO ESP32C6 | Espressif | `xiao_esp32c6/esp32c6/hpcore` | `blinky` | 🟢 构建验证 |
| XIAO ESP32S3 | Espressif | `xiao_esp32s3/esp32s3/procpu` | `blinky` | 🟢 构建验证 |
| XIAO ESP32C3 | Espressif | `xiao_esp32c3` | `hello_world` | 🟢 构建验证 · 板载无 LED |
| XIAO RA4M1 | Renesas | `xiao_ra4m1` | `blinky` | 🟢 构建验证 · USB DFU |
| XIAO ESP32C5 | Espressif | `xiao_esp32c5` | `hello_world` | ⛔ v4.4.0 暂无目标 |
