...
| XIAO MG24 | `xiao_mg24` | `examples/boards/xiao_mg24/blinky` | PASS | Builds; Debug Mate flashing needs Seeed's MG24 OpenOCD package |
...
For XIAO MG24 Debug Mate OpenOCD flashing requirements, see
