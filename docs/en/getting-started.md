...
such as `bossac` for SAMD21, the PyOCD CMSIS pack for MG24, and Renesas Flash
Programmer CLI for RA4M1. Running setup without `--board` installs the full
board-specific dependency set covered by this repository.
...
| XIAO RA4M1 | `xiao_ra4m1` | `examples/boards/xiao_ra4m1/blinky` | PASS | Builds; uses Zephyr's RFP runner by default |
...
For XIAO RA4M1 RFP flashing and USB bootloader entry, see
